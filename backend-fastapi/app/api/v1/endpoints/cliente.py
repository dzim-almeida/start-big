...
from app.schemas.cliente import ClientePFCreate, ClientePFRead, ClientePJCreate, ClientePJRead
...
def create_new_client_pf(
    ...
    Args:
        data_client (ClientePJCreate): Schema Pydantic com os dados do novo cliente.
        token (dict): Dependência que valida o token do usuário autenticado.
        db (Session): Dependência que injeta a sessão do banco de dados.
