...
class Cliente(Base):
    ...
    email = Column(String(255, collate="NOCASE"), unique=True, nullable=True)
...
class ClientePF(Base):
    ...
    nome = Column(String(255, collate="NOCASE"), index=True, nullable=False)  # Nome completo
    ...
    email = Column(String(255, collate="NOCASE"), unique=True, nullable=True) # Email, pode ser nulo e único
