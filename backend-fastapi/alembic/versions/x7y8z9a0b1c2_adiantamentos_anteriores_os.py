...
- Era `v5w6x7y8z9a0`, filha de `u4v5w6x7y8z9`. Renomeada em 19/09/2026 ao
  mesclar a rodada interestadual do fiscal, que criou `v5w6x7y8z9a0` com o
  mesmo ID no mesmo dia (os dois seguiram o padrão de nomes a partir da
  mesma head). Nunca rodou em banco de cliente com o ID antigo.
