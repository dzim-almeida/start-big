...
/**
 * ===========================================================================
 * ARQUIVO: OSEquipamentoSelectModal.vue
 * MODULO: Ordem de Servico
 * DESCRICAO: Modal para selecionar um equipamento do historico do cliente.
 * ===========================================================================
 */
...
const emit = defineEmits<{
  close: []; // Fecha sem selecionar (ou skip)
...
<template>
  <BaseModal
    ...
    @close="handleSkip"
  >
    <div class="space-y-4 max-h-100
     overflow-y-auto px-1 custom-scrollbar">
       
       <button
          v-for="(equip, idx) in equipamentos"
          :key="idx"
          type="button"
          class="w-full bg-white border border-slate-200 rounded-xl p-4 flex items-center justify-between hover:border-brand-primary-light0 hover:bg-brand-primary-light group transition-all text-left shadow-sm"
