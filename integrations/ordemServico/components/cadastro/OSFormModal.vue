...
/**
 * OSFormModal.vue
 * Modal para cadastro e edicao de Ordens de Servico
 * Refatorado: componentes extraidos para melhor manutenibilidade
 */
...
// Componentes de Secao (extraidos)
...
// Modais
import OSPrintTemplate from '../print/OSPrintTemplate.vue';
import OSFinalizarModal from './OSFinalizarModal.vue';
import ServicoFormModal from '../servicos/ServicoFormModal.vue';
...
import type { Cliente, EquipamentoHistorico } from '@/modules/clientes/types/clientes.types';
import { getClientEquipments } from '@/modules/clientes/services/cliente.service';
...
const isServicoModalOpen = ref(false);
...
<template>
  ...
  <OSItemFormModal
    ...
    @save="handleSaveItem"
    @create-new-service="isServicoModalOpen = true"
  />

  <ServicoFormModal :is-open="isServicoModalOpen" @close="isServicoModalOpen = false" />
