...
/**
 * OSFormHeader.vue
 * Header customizado do modal de OS com numero e botoes de acao
 */
...
// Formata o numero da OS removendo prefixos
...
<template>
  <div class="bg-[#0F172A] text-white p-5 rounded-t-2xl">
