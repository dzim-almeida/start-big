...
/**
 * OSFormFooter.vue
 * Footer do modal de OS com total e botao de finalizar
 */
...
<template>
  <div class="flex flex-col md:flex-row justify-between items-center gap-4">
    ...
    <div class="flex items-center gap-2">
      <!-- Botoes para OS Finalizada (vazio - acoes no header) -->
      <template v-if="isFinalizada">
        <!-- Acoes movidas para o header -->
      </template>

      <!-- Botoes Normais (se nao finalizada) -->
      <template v-else>
        <!-- Finalizar OS (so aparece em modo edicao e nao finalizada) -->
        <BaseButton
