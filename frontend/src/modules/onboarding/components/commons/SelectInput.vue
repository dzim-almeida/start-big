...
<template>
  <div class="relative h-fit">
    <select
      ...
      class="h-full px-3 py-2 border border-gray-300 rounded-md bg-transparent text-sm text-gray-700 focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary cursor-pointer appearance-none pr-8"
    >
