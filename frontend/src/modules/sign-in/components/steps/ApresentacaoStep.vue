...
/**
 * @component ApresentacaoStep
 * @description Tela de boas-vindas do sign-in (Passo 0).
 */
  ...
  <div class="max-w-lg mx-auto text-center py-8">
    ...
    <div class="space-y-4 mb-10">
      ...
      <p class="text-gray-500 text-base max-w-md mx-auto leading-relaxed">
        Em apenas <strong class="text-brand-action">5 passos simples</strong>, você terá acesso
