...
import type { OSAtrasadaItemData } from '../../schemas/dashboard.schema';

interface Props {
  items: OSAtrasadaItemData[];
  total: number;
}
...
async function handleClick(item: OSAtrasadaItemData) {
