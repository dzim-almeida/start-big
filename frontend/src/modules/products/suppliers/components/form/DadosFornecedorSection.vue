// ============================================================================
// COMPONENTE: DadosFornecedorSection (Sistema ERP Produto Motorista - Start Big)
// RESPONSABILIDADE: Formulário de dados empresariais e fiscais para fornecedores.
// FUNCIONALIDADES: Máscara dinâmica de CNPJ, campos opcionais de Inscrição 
//                  Estadual (IE) e gestão de contato com representantes.
// ============================================================================
