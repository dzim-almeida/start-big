...
<template>
  ...
  >
    <template #toolbar>
      ...
      <BaseFilter v-model="statusFilter" :filter-config="STATUS_FILTER_CONFIG" button-label="Status" />
    </template>
      ...
      <table class="w-full text-left min-w-120">
        <thead>
          ...
          >
            ...
            <th class="px-4 md:px-6 py-3 md:py-4">CNPJ</th>
            <th class="px-4 md:px-6 py-3 md:py-4">Contato</th>
            <th class="px-4 md:px-6 py-3 md:py-4">Representante</th>
        ...
        <tbody class="divide-y divide-zinc-100">
          ...
          >
            ...
            <td class="px-4 md:px-6 py-3 md:py-4">
              <span class="text-sm text-zinc-600 font-mono">{{ formatCnpj(fornecedor.cnpj) }}</span>
            </td>
            ...
            <td class="px-4 md:px-6 py-3 md:py-4">
              <span class="text-sm text-zinc-600">{{ fornecedor.representante || '—' }}</span>
            </td>
